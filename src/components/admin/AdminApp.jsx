          ...
          {panel === "contact" && (
            <div className="panel active">
              ...
              <div className="box">
                ...
                <Area label="Kode Embed Peta (URL src iframe)" value={C.contact.mapsEmbed} onChange={(v) => edit((c) => (c.contact.mapsEmbed = v))} rows={2} hint="Di Google Maps: Bagikan → Sematkan peta → salin URL di dalam src=&quot;...&quot;" />
              </div>
            </div>
          )}
