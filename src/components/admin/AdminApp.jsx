    ...
    <div className="app show">
      ...
      <div className="main">
        ...
        <div className="content">
          ...
          {panel === "hero" && (
            <div className="panel active">
              <div className="panel-intro"><h3>Hero / Banner</h3><p>Bagian paling atas website — kesan pertama pengunjung. Cukup isi bahasa Indonesia, versi bahasa Inggris dibuat otomatis.</p></div>
              <div className="box">
